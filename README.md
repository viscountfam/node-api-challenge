...
- [x] What can the API return to help clients know if a request was successful?
    We can help a client know that a request was successful by passing it the requested data or a success code.
- [x] How can we partition our application into sub-applications?
    We can partition our application into sub-application by splitting our server into multiple routers that each handle a few specific endpoints
